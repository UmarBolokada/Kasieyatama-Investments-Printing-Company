    ...
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center rounded-lg p-4 shadow-md bg-blue-100/30 backdrop-blur-md border border-purple-300/30">
              ...
              <p className="text-gray-600">
                Quick delivery on all orders with rush options available
              </p>
            </div>
            <div className="text-center rounded-lg p-4 shadow-md bg-green-100/30 backdrop-blur-md border border-green-300/30">
              ...
              <p className="text-gray-600">
                Premium materials and expert craftsmanship in every print
              </p>
            </div>
            <div className="text-center rounded-lg p-4 shadow-md bg-purple-100/30 backdrop-blur-md border border-purple-300/30">
              ...
              <p className="text-gray-600">
                Professional guidance and customer service throughout
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                &ldquo;Excellent quality and fast turnaround. The business cards
                look professional and the customer service was
                outstanding.&rdquo;
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                &ldquo;The custom banner printing exceeded my expectations.
                Great attention to detail and competitive pricing.&rdquo;
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gray-300 rounded-full mr-3"></div>
                <div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                &ldquo;Reliable service and consistent quality. They&apos;ve
                been our go-to printing partner for years.&rdquo;
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gray-300 rounded-full mr-3"></div>
                <div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Sierra Leone&apos;s No. 1 online print shop
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We&apos;ve had the privilege to work with some amazing companies
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center">
            {[
              "BAJAJ LOGO.jpg",
              "casham salone logo.jpg",
              "FREE QUALITY SAYAMADEE CLASS.jpg",
              "G4S LOGO.jpg",
              "GLOBAL CONNECT LOGO.jpg",
              "GT BANK LOGO.jpg",
              "heroes coffee logo.jpg",
              "SLRCS LOGO.jpg",
              "un women logo.jpg",
              "way-li logo.jpg",
            ].map((logo, index) => (
      ...
      <section className="py-16 bg-primary text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Whether you need business cards, banners, or custom printing
