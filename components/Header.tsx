    ...
    <header className="w-full bg-white shadow-md">
      ...
      <div className="w-full pr-4 flex items-center justify-between h-18 gap-2">
        ...
        <div className="flex items-center gap-2 sm:gap-4 min-w-0">
          <Link
            href="/"
            className="flex items-center gap-1 text-xl font-bold text-primary shrink-0"
          >
            <Image
              src="/kas logo2.png"
        ...
        <div className="hidden sm:flex items-center gap-4">
          ...
          <Link
            href="/cart"
            className="px-4 py-2 relative rounded bg-primary text-white font-medium hover:bg-primary/90 transition flex items-center gap-2"
          >
          ...
          <ClerkLoaded>
            <SignedIn>
              <Link
                href="/orders"
                className="px-4 py-2 rounded bg-gray-100 text-gray-800 font-medium hover:bg-gray-200 transition flex items-center gap-2"
              >
            ...
            {user ? (
              ...
              <SignInButton mode="modal">
                <p className="px-4 py-2 cursor-pointer rounded bg-primary text-white font-medium hover:bg-primary/90 transition">
                  Login
                </p>
              </SignInButton>
            )}
      ...
      {/* Mobile/Tablet Menu */}
      {menuOpen && (
        <nav className="sm:hidden flex items-center justify-center gap-4 text-sm text-gray-600">
          <Link
            href="/"
            className={`transition-colors ${
              isActive("/")
        ...
        <div className="md:hidden bg-white shadow-lg px-4 pb-4 pt-2 flex flex-col gap-3">
          ...
          {user ? (
            <div className="flex gap-2">
              ...
              <Link
                href="/orders"
                className="px-4 py-2 rounded bg-gray-100 text-gray-800 font-medium hover:bg-gray-200 transition flex items-center gap-2 basis-3/5"
              >
                <PackageIcon className="w-4 h-4" />
                <span>My Orders</span>
              </Link>
            ...
            <div className="flex flex-col gap-2">
              ...
              <SignInButton mode="modal">
                <p className="px-4 py-2 rounded bg-gray-100 text-gray-800 font-medium hover:bg-gray-200 transition">
                  Login
                </p>
              </SignInButton>
            </div>
